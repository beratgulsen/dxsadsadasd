...
const IDler = {
  botID: "861929468019736586",
  botSecret: "MBARpiXhNrYGjdHmXUgqVmhpyVzDE0Dd",
  botCallbackURL: "https://tested-smooth-door.glitch.me/callback",
  sunucuID: "863739528899198986",
  sunucuDavet: "https://discord.gg/wdC62b5",
  kodLogKanalı: "876191847700107335",
  sahipRolü: "865280336790290453",
  adminRolü: "865280336790290453",
  kodPaylaşımcıRolü: "865280336790290453",
  boosterRolü: "865280336790290453",
  kodPaylaşamayacakRoller: ["870177633445478401", "870177634477293611"],
  hazırAltyapılarRolü: "865280336790290453",
  hazırSistemlerRolü: "865280336790290453",
  sistemlerrolü: "865280336790290453",
  elmasKodlarRolü: "865280336790290453",
  altınKodlarRolü: "865280336790290453",
  normalKodlarRolü: "865280336790290453"
};
...
app.get("/davet", (req, res) => {
  res.redirect("https://discord.gg/SvX7zNVJZR");
});
...
app.get("/videolar", (req, res) => {
  res.redirect("https://www.youtube.com/channel/UCF41DqKvAmG3W4-PC8p8n8A");
});
...
client.on("ready", () => {
  const listener = app.listen(process.env.PORT, function() {
    client.user.setActivity(`Yit Code`, { type:"WATCHING" })
